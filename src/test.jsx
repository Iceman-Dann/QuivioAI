...
export default function QuizResults({ results, onNewQuiz, quiz, userData }) {
  ...
  try {
    ...
    const addHeaderFooter = (pageNum) => {
      ...
      pdf.setFontSize(16);
      pdf.text("Quivio AI - Results Report", 105, 10, { align: "center" });
      ...
      pdf.text(`Generated by Quivio AI | Page ${pageNum}`, 200, 285, { align: "right" });
    };
  ...
  const generateTextReport = () => {
    ...
    let report = `QUIVIO AI - RESULTS REPORT\n`;
