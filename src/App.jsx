              ...
              <div className="max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-3 gap-12 items-start">
                  ...
                  <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="inline-flex items-center gap-2 bg-yellow-100 border border-yellow-300 px-4 py-2 rounded-full text-sm font-medium text-yellow-800 mb-4">
                      <Star className="w-4 h-4" />
                      Built for Nexora Hacks 2026 • nexora-hacks-2026.devpost.com
                    </div>
            ...
            <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-white/50">
              <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                  ...
                  <div className="inline-flex items-center gap-2 bg-yellow-100 border border-yellow-300 px-4 py-2 rounded-full text-sm font-medium text-yellow-800 mb-4">
                    <Star className="w-4 h-4" />
                    Judge Notification: This project is a submission for Nexora Hacks 2026
                  </div>
            ...
            <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
              <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <span className="text-xl font-bold">Quivio AI - Nexora Hacks 2026</span>
                    </div>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                  <p>&copy; {new Date().getFullYear()} Quivio AI - Nexora Hacks 2026. All rights reserved. Powered by Google Gemini 2.5 Flash with Vision</p>
                </div>
              </div>
            </footer>
          </>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-right">
            <h1 className="text-2xl font-bold text-gray-900">Quivio AI</h1>
            <div className="inline-flex items-center gap-2 bg-yellow-100 border border-yellow-300 px-3 py-1 rounded-full text-xs font-medium text-yellow-800">
              <Star className="w-3 h-3" />
              Nexora Hacks 2026 Submission
            </div>
            <p className="text-sm text-gray-600">Quivio AI • Gemini 2.5 Vision</p>
          </div>
        </div>
