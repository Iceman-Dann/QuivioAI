import { FileText, Upload, Brain, Download, HelpCircle, Video, BookOpen, CheckCircle, AlertCircle, Info } from "lucide-react";
import { useState } from "react";

export default function Documentation() {
  const [activeSection, setActiveSection] = useState("file-upload");
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Step-by-step instructions to master Quivio AI and create amazing quizzes
          </p>
        </div>
