...
export default function QuizResults({ results, onNewQuiz, quiz, userData }) {
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      const addFooter = (pdf) => {
        ...
        // Footer text
        pdf.text("Generated by Quivio AI • 1/12/2026", pageWidth / 2, pageHeight - 15, { align: "center" });
        pdf.text("https://quivio-ai.com/", pageWidth / 2, pageHeight - 10, { align: "center" });
      };
  ...
  const downloadTextReport = () => {
    ...
    link.download = `mcq-quiz-results-${userData?.userName || "student"}-${new Date().getTime()}.txt`;
    link.href = url;
    link.click();
  ...
  const generateTextReport = () => {
    ...
    report += `\n---\n`;
    report += `Generated by Quivio AI • 1/12/2026\n`;
    report += `https://quivio-ai.com/\n`;
